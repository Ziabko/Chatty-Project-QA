...
public class ContactPage {
    ...
    public void checkSuccessMessage(String expectedSuccessMessage) {
        successMessage.shouldBe(visible).shouldHave(text(expectedSuccessMessage));
    }
    ...
    public void getErrorMessageEmptyNameField(String expectedErrorMessageEmptyName) {
        userNameField.shouldBe(visible).shouldHave(Condition.attribute("validationMessage", expectedErrorMessageEmptyName));
    }

    public void getErrorMessageEmptyEmailField(String expectedErrorMessageEmptyEmail) {
        emailField.shouldBe(visible).shouldHave(Condition.attribute("validationMessage", expectedErrorMessageEmptyEmail));
    }

    public void getErrorMessageEmptyContentField(String expectedErrorMessageEmptyContent) {
        contentField.shouldBe(visible).shouldHave(Condition.attribute("validationMessage", expectedErrorMessageEmptyContent));
    }

    public void getErrorMessageInvalidEmailWithoutAt(String expectedTextMessage) {
        errorMessageEmail.shouldBe(visible).shouldHave(text(expectedTextMessage));
    }
