...
public class ProfileRedactionPage {
    ...
    public void checkChangeOldPasswordField(String ValueOldPassword){changeOldPasswordField.setValue(ValueOldPassword);
    }
    public void checkChangeNewPasswordField(String ValueNewPassword){changeNewPasswordField.setValue(ValueNewPassword);
    }
    public void checkChangeConfirmNewPasswordField(String ValueConfirmNewPassword){changeConfirmNewPasswordField.setValue(ValueConfirmNewPassword);
    }
    public void clickSaveChangePasswordButton(){saveChangePasswordButton.click();
    }
